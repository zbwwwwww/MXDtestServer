...
public class GameConstants {
    ...
    /**
     * 职业编号 → 中文职业名。只覆盖 v83 五大职业系的 41 个可玩编号，查不到返回空串。
     *
     * 单独开一个方法，而不是改 getJobName(int)：后者返回英文名，被
     * MapleCharacter.changeJob 的转职公告（整句英文）使用，改成中文会中英混杂。
     * 本表必须与 scripts/npc/gm_menu.js 里的 JOBS 表保持一致。
     */
    public static String getJobNameCn(int jobid) {
        switch (jobid) {
            // 战士系
            case 100: return "战士";
            case 110: return "剑客";
            ...
            case 212: return "火毒魔导师";
            case 220: return "冰雷法师";
            case 221: return "冰雷巫师";
            case 222: return "冰雷魔导师";
            case 230: return "牧师";
            case 231: return "祭司";
            case 232: return "主教";
            // 弓手系
